#!/usr/bin/env python3
"""apps/todo/macos/CHANGELOG.md を扱う補助コマンド。release.sh から呼ぶ。
...
CHANGELOG の書式は apps/todo/macos/CHANGELOG.md 冒頭の「書き方」を参照。
...
def cmd_check():
    if not unreleased_body(read()):
        sys.exit(
            ...
            "       git log <前回タグ>..HEAD を読んで apps/todo/macos/CHANGELOG.md の [Unreleased] を埋め、\n"
